...
```
[Hook — first line, before "...more" truncation]
[One line break]
[2-3 sentences of substance: dish story, price, why it's good]
[One line break]
[CTA — "Order now →" / "Link in bio" / "Tag someone who needs this"]
[Hashtags — 5-8]
```
...
Our 麻辣香锅 (Dry-Spicy Stir-Fry Pot) is the most-reordered dish
we have. Wok-fired at high heat, hand-picked spice level,
$16.90 for a portion that actually fills you up.

Tap the link in bio to order. Contains: peanuts, sesame, soy.

#chinesefood #fooddelivery #malaxiangguo #authenticchinese #lunchspecial
```
